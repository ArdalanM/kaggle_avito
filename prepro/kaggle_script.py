...
FOLDER = "/home/ardalan/Documents/kaggle/avito/data/"
...
def prep_train():
    ...
    pairs = pd.read_csv(FOLDER + "ItemPairs_train.csv", dtype=types1)
    # Add 'id' column for easy merge
    print("Load ItemInfo_train.csv")
    items = pd.read_csv(FOLDER + "ItemInfo_train.csv", dtype=types2)
    items.fillna(-1, inplace=True)
    location = pd.read_csv(FOLDER + "Location.csv")
    category = pd.read_csv(FOLDER + "Category.csv")
...
def prep_test():
    ...
    pairs = pd.read_csv(FOLDER + "ItemPairs_test.csv", dtype=types1)
    print("Load ItemInfo_testcsv")
    items = pd.read_csv(FOLDER + "ItemInfo_test.csv", dtype=types2)
    items.fillna(-1, inplace=True)
    location = pd.read_csv(FOLDER + "Location.csv")
    category = pd.read_csv(FOLDER + "Category.csv")
